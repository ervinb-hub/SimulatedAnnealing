...
![P = e^{-\dfrac{\Delta E}{T}}](https://render.githubusercontent.com/render/math?math=P%20%3D%20e%5E%7B-%5Cdfrac%7B%5CDelta%20E%7D%7BT%7D%7D)
...
|:-:|:-:|:-:|
|![](img/f1.png){:height="50%" width="50%"}|![](img/f2.png){:height="50%" width="50%"}|![](img/f3.png){:height="50%" width="50%"}|
|Fig. 1|Fig. 2|Fig. 3|
